  ...
  ============================*/}
    ...
    ============================*/}
            ...
            dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</p>
                            ...
                            <div className="skills-content">
                                ...
                                <div className="progress">
                                    <div className="progress-bar bg-warning" role="progressbar" aria-valuenow="75" aria-valuemin="0"
                                        aria-valuemax="100">
                                ...
                                <div className="progress">
                                    <div className="progress-bar bg-danger" role="progressbar" aria-valuenow="55" aria-valuemin="0"
                                        aria-valuemax="100">
                    ...
                    <section id="facts" className="wow fadeIn">
                        <div className="container">
                            ...
                            <div className="facts-img">
                                <img src={process.env.PUBLIC_URL + "/assets/img/facts-img.png"} alt="" className="img-fluid" />
                            </div>
                            ...
                            <div className="row portfolio-container">
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/app1.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/app1.jpg"} data-lightbox="portfolio" data-title="App 1" className="link-preview"
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/web3.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/web3.jpg"} className="link-preview" data-lightbox="portfolio" data-title="Web 3"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/app2.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/app2.jpg"} className="link-preview" data-lightbox="portfolio" data-title="App 2"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/card2.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/card2.jpg"} className="link-preview" data-lightbox="portfolio" data-title="Card 2"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/web2.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/web2.jpg"} className="link-preview" data-lightbox="portfolio" data-title="Web 2"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/app3.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/app3.jpg"} className="link-preview" data-lightbox="portfolio" data-title="App 3"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/card1.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/card1.jpg"} className="link-preview" data-lightbox="portfolio" data-title="Card 1"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/card3.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/card3.jpg"} className="link-preview" data-lightbox="portfolio" data-title="Card 3"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                                ...
                                <div className="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.2s">
                                    <div className="portfolio-wrap">
                                        <figure>
                                            <img src={process.env.PUBLIC_URL + "/assets/img/portfolio/web1.jpg"} className="img-fluid" alt="" />
                                            <a href={process.env.PUBLIC_URL + "/assets/img/portfolio/web1.jpg"} className="link-preview" data-lightbox="portfolio" data-title="Web 1"
                                                title="Preview"><i className="ion ion-eye"></i></a>
                                            <a href="#" className="link-details" title="More Details"><i className="ion ion-android-open"></i></a>
                                        </figure>
                    ...
                    <section id="clients" className="wow fadeInUp">
                        <div className="container">
                            ...
                            <div className="owl-carousel clients-carousel">
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-1.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-2.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-3.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-4.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-5.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-6.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-7.png"} alt="" />
                                <img src={process.env.PUBLIC_URL + "/assets/img/clients/client-8.png"} alt="" />
                            </div>
    ...
    ============================*/}
                        ...
                        <div className="container">
                            ...
                            <div className="owl-carousel testimonials-carousel">
                                ...
                                <div className="testimonial-item">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/testimonial-1.jpg"} className="testimonial-img" alt="" />
                                    <h3>Saul Goodman</h3>
                                    <h4>Ceo &amp; Founder</h4>
                                    <p>
                                        <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-left.png"} className="quote-sign-left" alt="" />
                                        Proin iaculis purus consequat sem cure digni ssim donec porttitora entum suscipit rhoncus. Accusantium
                                        quam, ultricies eget id, aliquam eget nibh et. Maecen aliquam, risus at semper.
              <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-right.png"} className="quote-sign-right" alt="" />
                                    </p>
                                </div>

                                <div className="testimonial-item">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/testimonial-2.jpg"} className="testimonial-img" alt="" />
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                    <p>
                                        <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-left.png"} className="quote-sign-left" alt="" />
              ...
              <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-right.png"} className="quote-sign-right" alt="" />
                                ...
                                <div className="testimonial-item">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/testimonial-3.jpg"} className="testimonial-img" alt="" />
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                    <p>
                                        <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-left.png"} className="quote-sign-left" alt="" />
              ...
              <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-right.png"} className="quote-sign-right" alt="" />
                                ...
                                <div className="testimonial-item">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/testimonial-4.jpg"} className="testimonial-img" alt="" />
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                    <p>
                                        <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-left.png"} className="quote-sign-left" alt="" />
              ...
              <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-right.png"} className="quote-sign-right" alt="" />
                                ...
                                <div className="testimonial-item">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/testimonial-5.jpg"} className="testimonial-img" alt="" />
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                    <p>
                                        <img src={process.env.PUBLIC_URL + "/assets/img/quote-sign-left.png"} className="quote-sign-left" alt="" />
